...
var cornerstone = require('./cornerstone2.js');
...
if(typeof cornerstoneWADOImageLoader.internal === 'undefined'){
 ...
 */
  ...
  function loadImage2(imageId, options) {
    var start = new Date().getTime();
    ...
    //   reject('no metadata for imageIded ' + imageId);
    //   return deferred;
    // }
  ...
  cornerstone.registerImageLoader('wadors', loadImage2);
 ...
 */
  ...
  // module exports
  cornerstoneWADOImageLoader.wadors.metaDataProvider = metaDataProvider1
 ...
 */
  ...
  function addMeta(imageId, metadata) {
  ...
  // module exports
module.exports = cornerstoneWADOImageLoader.wadors.metaDataManager = {
    add : addMeta,
    get : getMeta,
    remove:removeMeta,
    purge: purgeMeta
 ...
 */
  ...
  function load(uri, loadRequest, imageId) {
    ...
    if(loadedDataSets[uri]) {
      ...
      var alreadyLoadedpromise = new Promise(function(resolve  , reject){
    ...
    var loadDeferred = new Promise(function(resolve , reject){
 ...
 */
  ...
  var defaultConfig = {
    ...
    webWorkerPath : './public/cornerstone/cornerstoneWADOImageLoaderWebWorker.js',
    webWorkerTaskPaths: [],
    taskConfiguration: {
      'decodeTask' : {
        loadCodecsOnStartup : true,
        initializeCodecsOnStartup: false,
        codecsPath: '../codecs/Allcodecs.min.js',
        usePDFJS: false
      }
    }
  };
  ...
  var P2 = msg.data.result
  var P3 =   webWorkers[msg.data.workerIndex].task.resolver;
 
   P3(P2)

     // webWorkers[msg.data.workerIndex].task.resolver(P2);
