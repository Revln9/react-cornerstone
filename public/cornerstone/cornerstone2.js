...
(function ( cornerstone) {
    ...
    function displayImage(element, image, viewport) {
        ...
        var event1 = new CustomEvent("CornerstoneNewImage", newImageEventData);

                enabledElement.element.dispatchEvent(event1);
        ...
        function draw() {
            ...
            if (el.needsRedraw && el.image !== undefined){
                ...
                var eventData = {
                  ...
                  var event1 = new CustomEvent("CornerstoneImageRendered", eventData);
                el.element.dispatchEvent(event1);
...
(function ( cornerstone) {
    ...
    function loadImageFromImageLoader(imageId, options) {
        ...
        imagePromise.then(function(image) {
            ...
            var event1 = new CustomEvent('CornerstoneImageLoaded', {image: image});
...
var event1 = new CustomEvent("CornerstoneInvalidated", eventData);
